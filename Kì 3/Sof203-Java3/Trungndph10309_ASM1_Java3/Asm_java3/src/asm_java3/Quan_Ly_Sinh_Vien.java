...
public class Quan_Ly_Sinh_Vien extends javax.swing.JFrame {
    ...
    ArrayList<QLSV> lst = new ArrayList<>();
    ...
    public void Filltable() {
        ...
        for (QLSV x : lst) {
            model.addRow(new Object[]{
                x.MaSV, x.HoTen, x.Email, x.SDT, x.GioiTinh, x.DiaChi, x.Img
            });
        }
    ...
    public boolean CheckMa() {
        for (QLSV x : lst) {
            if (txt_MaSV.getText().equals(x.MaSV)) {
                return true;
            }
        }
        return false;
    ...
    public void Showdetail() {
        if (index != -1) {
            txt_name.setText(lst.get(index).getHoTen());
            txt_SDT.setText(lst.get(index).getSDT());
            txt_Email.setText(lst.get(index).getEmail());
            txt_MaSV.setText(lst.get(index).getMaSV());
            try {
                jLabel8.setIcon(new ImageIcon(ImageIO.read(new File("D:\\ảnh nền\\" + lst.get(index).Img)).getScaledInstance(90, 105, SCALE_DEFAULT)));
            } catch (IOException ex) {
                Logger.getLogger(Quan_Ly_Sinh_Vien.class.getName()).log(Level.SEVERE, null, ex);
            }
            txt_Address.setText(lst.get(index).DiaChi);
            if (lst.get(index).GioiTinh.equals("Nam")) {
    ...
    public void copyFile() {
        ...
        try {
            File des = new File("D:\\ảnh nền\\" + txt_MaSV.getText()
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Images/Delete.png"))); // NOI18N
    ...
    private void btn_SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SaveActionPerformed
        ...
        if (txt_MaSV.getText().equals("") || txt_name.getText().equals("")
            ...
            ql.GioiTinh = rdo_Nam.isSelected() ? "Nam" : "Nữ";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        int selected = tbl_QLSV.getSelectedRow();
        ((DefaultTableModel) tbl_QLSV.getModel()).getDataVector().remove(selected);
        lst.remove(selected);
        Filltable();
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        ...
        if (jfc.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                jLabel8.setIcon(new ImageIcon(ImageIO.read(selected).getScaledInstance(90, 105, SCALE_DEFAULT)));
            } catch (IOException ex) {
                Logger.getLogger(Quan_Ly_Sinh_Vien.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
