...
//                }
    ...
    private void btn_SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SaveActionPerformed
        // TODO add your handling code here:
        if (txt_manv.getText().equals("") || txt_Hoten.getText().equals("") || txt_tuoi.getText().equals("")
                || txt_email.getText().equals("")
                || txt_luong.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Ban phai nhap day du form");
        } else {
            Employee emp = new Employee();
            emp.code = txt_manv.getText();
            emp.name = txt_Hoten.getText();
            emp.Email = txt_email.getText();
            emp.age = Integer.parseInt(txt_tuoi.getText());
            emp.salary = Double.parseDouble(txt_luong.getText());
            lst.add(emp);
            this.fillTable();
        }
