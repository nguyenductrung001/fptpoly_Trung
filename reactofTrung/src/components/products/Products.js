...
function Products() {
    ...
    useEffect(() => {
        ...
        const url = 'https://6012527d84695f001777a028.mockapi.io/categories/'+danhMucId+'/products?limit=' + limit +
        "&page=" + page;
...
setPage(1);
    ...
    const onCrateProduct = () => {
        ...
        const urlApiThemMoi = 'https://6012527d84695f001777a028.mockapi.io/categories' + danhMucId+'products';
    ...
    const onUpdateProduct = function () {
        const apiUpdate = 'https://6012527d84695f001777a028.mockapi.io/categories' +danhMucId+'products' + formData.id;
    ...
    const btnDeleteOnClick = function (event, value, index) {
        ...
        const apiXoaUrl = `https://6012527d84695f001777a028.mockapi.io/categories/${danhMucId}/products/${value.id}`;
